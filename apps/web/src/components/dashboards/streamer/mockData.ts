...
export const mockClips: Clip[] = [
  ...
  },
  {
    ...
    thumbnailUrl: "/api/placeholder/320/180",
    path: "/clips/artifact-clip-3.mp4",
    duration: 30,
    status: "processing",
